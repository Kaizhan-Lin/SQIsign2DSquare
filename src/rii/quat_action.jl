...
# return a generator of E[(alpha, l^e)], and a generator of the dual
function kernel_generator_and_for_dual(xP::Proj1{FqFieldElem}, xQ::Proj1{FqFieldElem}, xPQ::Proj1{FqFieldElem}, a24::Proj1{FqFieldElem},
    alpha::QOrderElem, l::Int, e::Int, Ms::Vector{Matrix{T}}) where T <: Integer
    a, b = kernel_coefficients(alpha, l, e, Ms)
    if a == 1
        return ladder3pt(b, xP, xQ, xPQ, a24), xQ
    else
        return ladder3pt(a, xQ, xP, xPQ, a24), xP
    end
end